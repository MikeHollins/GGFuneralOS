# GGFuneralOS — Codex Rules

> Global Codex rules (identity, intent detection, phase gates, fail-closed, Dregwise, security baseline, priority hierarchy) live in `~/AGENTS.md` and load automatically. This file covers only project-specific rules, stack, and architecture.
